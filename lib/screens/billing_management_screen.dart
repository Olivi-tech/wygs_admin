                            ...
                            child: DataTable(
                              decoration: BoxDecoration(
                                ...
                                color: MaterialStateColor.resolveWith(
                                    (states) =>
                                        Provider.of<BillingCheckProvider>(
                                                            context)
                                                        .selectedIndices
                                                        .length ==
                                                    billingData.length &&
                              ...
                              columns: [
                                ...
                                const DataColumn(
                                  label: Expanded(
                                      child:
                                          CustomTextDataColumn(text: 'Name')),
                                ),
                                const DataColumn(
                                  label: Expanded(
                                ...
                                const DataColumn(
                                  label: Expanded(
                                      child:
                                          CustomTextDataColumn(text: 'Type')),
                                ),
                                const DataColumn(
                                  label: Expanded(
                                      child:
                                          CustomTextDataColumn(text: 'Price')),
                                ),
                                DataColumn(
                                  label: Expanded(
                                    child: Row(
