                      ...
                      child: SingleChildScrollView(
                        ...
                        child: DataTable(
                          ...
                          rows: progressData
                            ...
                            String completedDay = '${model.completedDays}';
                            int numericValue = extractDayValue(completedDay);
                            return DataRow(
                              ...
                              cells: [
                                ...
                                DataCell(
                                  InkWell(
                                      onTap: () => questionDialogLeadGuitar(
                                          context, controller, model.userId!),
                                ...
                                DataCell(
                                  InkWell(
                                      onTap: () => numericValue >= 3
                                          ? questionDialogBassGuitar(context,
                                ...
                                DataCell(
                                  InkWell(
                                      onTap: () => numericValue >= 6
                                          ? questionDialogKeyboard(context,
                                              controller, model.userId!)
                                          : toastMessage(
                                              'The user has not submitted yet.'),
                                      child: buildContainer(
